...
| **Instrument Screener** | Obtain lists of companies, cryptocurrencies, forex, commodities, etfs and indices including quotes, sector performance, winners and losers to find and select tickers to use in the Finance Toolkit. This uses the `Utilities` class which can be accessed by using `from financetoolkit import Utilities`. For more information have a look [here](https://www.jeroenbouma.com/projects/financetoolkit/docs/utilities) |
